...
__all__ = ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152', 'resnext50_32x4d', 'resnext101_32x8d', 'resnet50_fc512']
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, loss, block, layers, zero_init_residual=False, groups=1, width_per_group=64, replace_stride_with_dilation=None, norm_layer=None, last_stride=2, fc_dims=None, dropout_p=None, **kwargs):
        ...
        self.conv1 = nn.Conv(3, self.inplanes, 7, stride=2, padding=3, bias=False)
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, Bottleneck):
                    init.constant_(m.bn3.weight, value=0)
                elif isinstance(m, BasicBlock):
                    init.constant_(m.bn2.weight, value=0)
