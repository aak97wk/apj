...
class Match(object):
    ...
    def __init__(self, match_results):
        ...
        if (match_results.dtype not in (jt.int32, jt.int64)):
    ...
    def matched_column_indices(self):
        ...
        return self._reshape_and_cast(jt.where((self._match_results > (- 1))))
    ...
    def ignored_column_indices(self):
        ...
        return self._reshape_and_cast(jt.where(self.ignored_column_indicator()))
    ...
    def unmatched_or_ignored_column_indices(self):
        ...
        return self._reshape_and_cast(jt.where((0 > self._match_results)))
    ...
    def matched_row_indices(self):
        ...
        return self._reshape_and_cast(jt.gather(self._match_results, 0, self.matched_column_indices()))

    def _reshape_and_cast(self, t):
        return jt.reshape(t, [(- 1)]).long()
    ...
    def gather_based_on_match(self, input_tensor, unmatched_value, ignored_value):
        ...
        ss = jt.stack([ignored_value, unmatched_value])
        input_tensor = jt.contrib.concat([ss, input_tensor], dim=0)
        gather_indices = jt.clamp((self.match_results + 2), min_v=0)
        gathered_tensor = input_tensor[gather_indices]
