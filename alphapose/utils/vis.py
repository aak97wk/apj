...
def get_smpl_color(idx):
    color_pool = [[int((0.65098039 * 255)), int((0.74117647 * 255)), int((0.85882353 * 255))], [(0.9 * 255), (0.7 * 255), (0.7 * 255)], [120, 198, 121], [(0.74117647 * 255), (0.65098039 * 255), (0.85882353 * 255)], [(0.7 * 255), (0.9 * 255), (0.7 * 255)], [198, 120, 121], CYAN, WHITE]
    color = color_pool[(idx % 8)]
    return color
...
def vis_frame_fast(frame, im_res, opt, vis_thres, format='coco'):
    ...
    if (kp_num == 17):
        if (format == 'coco'):
            l_pair = [(0, 1), (0, 2), (1, 3), (2, 4), (5, 6), (5, 7), (7, 9), (6, 8), (8, 10), (17, 11), (17, 12), (11, 13), (12, 14), (13, 15), (14, 16)]
            p_color = [(0, 255, 255), (0, 191, 255), (0, 255, 102), (0, 77, 255), (0, 255, 0), (77, 255, 255), (77, 255, 204), (77, 204, 255), (191, 255, 77), (77, 191, 255), (191, 255, 77), (204, 77, 255), (77, 255, 204), (191, 77, 255), (77, 255, 191), (127, 77, 255), (77, 255, 127), (0, 255, 255)]
            line_color = [(0, 215, 255), (0, 255, 204), (0, 134, 255), (0, 255, 50), (77, 255, 222), (77, 196, 255), (77, 135, 255), (191, 255, 77), (77, 255, 77), (77, 222, 255), (255, 156, 127), (0, 127, 255), (255, 127, 77), (0, 77, 255), (255, 77, 36)]
        elif (format == 'mpii'):
            l_pair = [(8, 9), (11, 12), (11, 10), (2, 1), (1, 0), (13, 14), (14, 15), (3, 4), (4, 5), (8, 7), (7, 6), (6, 2), (6, 3), (8, 12), (8, 13)]
            p_color = [PURPLE, BLUE, BLUE, RED, RED, BLUE, BLUE, RED, RED, PURPLE, PURPLE, PURPLE, RED, RED, BLUE, BLUE]
        else:
            raise NotImplementedError
    elif (kp_num == 136):
        l_pair = [(0, 1), (0, 2), (1, 3), (2, 4), (5, 18), (6, 18), (5, 7), (7, 9), (6, 8), (8, 10), (17, 18), (18, 19), (19, 11), (19, 12), (11, 13), (12, 14), (13, 15), (14, 16), (20, 24), (21, 25), (23, 25), (22, 24), (15, 24), (16, 25), (26, 27), (27, 28), (28, 29), (29, 30), (30, 31), (31, 32), (32, 33), (33, 34), (34, 35), (35, 36), (36, 37), (37, 38), (38, 39), (39, 40), (40, 41), (41, 42), (43, 44), (44, 45), (45, 46), (46, 47), (48, 49), (49, 50), (50, 51), (51, 52), (53, 54), (54, 55), (55, 56), (57, 58), (58, 59), (59, 60), (60, 61), (62, 63), (63, 64), (64, 65), (65, 66), (66, 67), (68, 69), (69, 70), (70, 71), (71, 72), (72, 73), (74, 75), (75, 76), (76, 77), (77, 78), (78, 79), (79, 80), (80, 81), (81, 82), (82, 83), (83, 84), (84, 85), (85, 86), (86, 87), (87, 88), (88, 89), (89, 90), (90, 91), (91, 92), (92, 93), (94, 95), (95, 96), (96, 97), (97, 98), (94, 99), (99, 100), (100, 101), (101, 102), (94, 103), (103, 104), (104, 105), (105, 106), (94, 107), (107, 108), (108, 109), (109, 110), (94, 111), (111, 112), (112, 113), (113, 114), (115, 116), (116, 117), (117, 118), (118, 119), (115, 120), (120, 121), (121, 122), (122, 123), (115, 124), (124, 125), (125, 126), (126, 127), (115, 128), (128, 129), (129, 130), (130, 131), (115, 132), (132, 133), (133, 134), (134, 135)]
        p_color = [(0, 255, 255), (0, 191, 255), (0, 255, 102), (0, 77, 255), (0, 255, 0), (77, 255, 255), (77, 255, 204), (77, 204, 255), (191, 255, 77), (77, 191, 255), (191, 255, 77), (204, 77, 255), (77, 255, 204), (191, 77, 255), (77, 255, 191), (127, 77, 255), (77, 255, 127), (77, 255, 255), (0, 255, 255), (77, 204, 255), (0, 255, 255), (0, 191, 255), (0, 255, 102), (0, 77, 255), (0, 255, 0), (77, 255, 255)]
        line_color = [(0, 215, 255), (0, 255, 204), (0, 134, 255), (0, 255, 50
0, 127, 255), (255, 127, 77), (0, 77, 255), (255, 77, 36), (0, 77, 255), (0, 77, 255), (0, 77, 255), (0, 77, 255), (255, 156, 127), (255, 156, 127)]
    elif (kp_num == 26):
        l_pair = [(0, 1), (0, 2), (1, 3), (2, 4), (5, 18), (6, 18), (5, 7), (7, 9), (6, 8), (8, 10), (17, 18), (18, 19), (19, 11), (19, 12), (11, 13), (12, 14), (13, 15), (14, 16), (20, 24), (21, 25), (23, 25), (22, 24), (15, 24), (16, 25)]
        p_color = [(0, 255, 255), (0, 191, 255), (0, 255, 102), (0, 77, 255), (0, 255, 0), (77, 255, 255), (77, 255, 204), (77, 204, 255), (191, 255, 77), (77, 191, 255), (191, 255, 77), (204, 77, 255), (77, 255, 204), (191, 77, 255), (77, 255, 191), (127, 77, 255), (77, 255, 127), (77, 255, 255), (0, 255, 255), (77, 204, 255), (0, 255, 255), (0, 191, 255), (0, 255, 102), (0, 77, 255), (0, 255, 0), (77, 255, 255)]
        line_color = [(0, 215, 255), (0, 255, 204), (0, 134, 255), (0, 255, 50), (0, 255, 102), (77, 255, 222), (77, 196, 255), (77, 135, 255), (191, 255, 77), (77, 255, 77), (77, 191, 255), (204, 77, 255), (77, 222, 255), (255, 156, 127), (0, 127, 255), (255, 127, 77), (0, 77, 255), (255, 77, 36), (0, 77, 255), (0, 77, 255), (0, 77, 255), (0, 77, 255), (255, 156, 127), (255, 156, 127)]
    elif (kp_num == 21):
        l_pair = [(0, 1), (1, 2), (2, 3), (3, 4), (0, 5), (5, 6), (6, 7), (7, 8), (0, 9), (9, 10), (10, 11), (11, 12), (0, 13), (13, 14), (14, 15), (15, 16), (0, 17), (17, 18), (18, 19), (19, 20), (21, 22), (22, 23), (23, 24), (24, 25), (21, 26), (26, 27), (27, 28), (28, 29), (21, 30), (30, 31), (31, 32), (32, 33), (21, 34), (34, 35), (35, 36), (36, 37), (21, 38), (38, 39), (39, 40), (40, 41)]
        p_color = [(255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255)]
        line_color = [(255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255), (255, 255, 255)]
    else:
        raise NotImplementedError
    img = frame.copy()
...
def vis_frame_smpl(frame, im_res, smpl_output, opt, vis_thres):
    ...
    all_transl = smpl_output['transl'].detach().numpy()
    vertices = smpl_output['pred_vertices'].detach().numpy()
    for (n_human, human) in enumerate(im_res['result']):
        ...
        renderer = SMPLRenderer(img_size=img_size, focal=focal, princpt=princpt)
        transl = all_transl[n_human].squeeze(-1)
        transl[2] = ((transl[2] * 256) / (bbox[1] - bbox[0]))
        vert = vertices[n_human]
        img = vis_smpl_3d(vert, img, cam_root=transl, f=focal, c=princpt, renderer=renderer, color=[(c / 255) for c in color])
    return img

def vis_smpl_3d(vert, img, cam_root, f, c, renderer, color=None, cam_rt=np.zeros(3), cam_t=np.zeros(3), J_regressor_h36m=None):
    ...
    rend_img_overlay = renderer(vert_shifted, princpt=c, img=img, do_alpha=True, color=color, cam_rt=cam_rt, cam_t=cam_t)
...
def vis_frame_skeleton(frame, im_res, smpl_output, opt, vis_thres):
    ...
    focal = np.array([1000, 1000])
    all_transl = smpl_output['transl'].detach().numpy()
    l_pair = [(15, 12), (12, 9), (9, 13), (13, 16), (16, 18), (18, 20), (20, 22), (9, 14), (14, 17), (17, 19), (19, 21), (21, 23), (9, 6), (6, 3), (3, 0), (0, 1), (1, 4), (4, 7), (7, 10), (0, 2), (2, 5), (5, 8), (8, 11)]
    ...
    for (n_human, human) in enumerate(im_res['result']):
        ...
        for n in range(len(l_pair)):
            (cor_x_1, cor_y_1) = (int(kp_preds[(l_pair[n][0], 0)]), int(kp_preds[(l_pair[n][0], 1)]))
            (cor_x_2, cor_y_2) = (int(kp_preds[(l_pair[n][1], 0)]), int(kp_preds[(l_pair[n][1], 1)]))
            if opt.tracking:
                cv2.circle(img, (cor_x_1, cor_y_1), 3, color, (- 1))
                cv2.circle(img, (cor_x_2, cor_y_2), 3, color, (- 1))
                cv2.line(img, (cor_x_1, cor_y_1), (cor_x_2, cor_y_2), color, ((2 * int((kp_scores[l_pair[n][0]] + kp_scores[l_pair[n][1]]))) + 1))
            else:
                cv2.circle(img, (cor_x_1, cor_y_1), 3, (int((colors[n][0] * 255)), int((colors[n][1] * 255)), int((colors[n][2] * 255))), (- 1))
                cv2.circle(img, (cor_x_2, cor_y_2), 3, (int((colors[n][0] * 255)), int((colors[n][1] * 255)), int((colors[n][2] * 255))), (- 1))
                cv2.line(img, (cor_x_1, cor_y_1), (cor_x_2, cor_y_2), (int((colors[n][0] * 255)), int((colors[n][1] * 255)), int((colors[n][2] * 255))), ((2 * int((kp_scores[l_pair[n][0]] + kp_scores[l_pair[n][1]]))) + 1))
        transl = all_transl[n_human].squeeze(-1)
        ...
        for l in range(len(l_pair)):
            ...
            if ((kp_scores[(i1, 0)] > 0) and (kp_scores[(i2, 0)] > 0)):
                ax.plot(x, z, (- y), color=(colors[l] if (not opt.tracking) else (np.array(color) / 255)), linewidth=2)
            if (kp_scores[(i1, 0)] > 0):
                ax.scatter(xyz_preds[(i1, 0)], xyz_preds[(i1, 2)], (- xyz_preds[(i1, 1)]), color=(colors[l] if (not opt.tracking) else (np.array(color) / 255)), marker='o')
            if (kp_scores[(i2, 0)] > 0):
                ax.scatter(xyz_preds[(i2, 0)], xyz_preds[(i2, 2)], (- xyz_preds[(i2, 1)]), color=(colors[l] if (not opt.tracking) else (np.array(color) / 255)), marker='o')
            (x_min, y_min, z_min) = (min(xyz_preds[:, 0].min(), x_min), min(xyz_preds[:, 1].min(), y_min), min(xyz_preds[:, 2].min(), z_min))
            (x_max, y_max, z_max) = (max(xyz_preds[:, 0].max(), x_max), max(xyz_preds[:, 1].max(), y_max), max(xyz_preds[:, 2].max(), z_max))
    ...
    cat_img = np.zeros((max(skeleton_img.shape[0], img.shape[0]), (skeleton_img.shape[1] + img.shape[1]), 3))
    cat_img[((cat_img.shape[0] - img.shape[0]) // 2):(((cat_img.shape[0] - img.shape[0]) // 2) + img.shape[0]), :img.shape[1], :] = img
    cat_img[((cat_img.shape[0] - skeleton_img.shape[0]) // 2):(((cat_img.shape[0] - skeleton_img.shape[0]) // 2) + skeleton_img.shape[0]), img.shape[1]:, :] = skeleton_img
    return cat_img
