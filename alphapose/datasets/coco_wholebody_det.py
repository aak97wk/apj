...
class coco_wholebody_det(Dataset):
    ' Coco WholeBody human detection box dataset.\n\n    '
    ...
    def __len__(self):
        return super(coco_wholebody_det, self).__len__()
