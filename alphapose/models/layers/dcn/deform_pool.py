...
class DeformRoIPoolingFunction(Function):
    ...
    @staticmethod
    def execute(ctx, data, rois, offset, spatial_scale, out_size, out_channels, no_trans, group_size=1, part_size=None, sample_per_part=4, trans_std=0.0):
